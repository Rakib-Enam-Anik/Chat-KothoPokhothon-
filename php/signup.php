        ...
        if(filter_var($email, FILTER_VALIDATE_EMAIL)){
            ...
            //let's check that email already exist in the database or not
             ...
             if(mysqli_num_rows($sql) > 0){
                ...
                echo "$email - This email already exusts!";
             }else{
                ...
                if(isset($_FILES['file'])){//if file is uploaded
                    ...
                    $img_ext = end($img_explode); //here we get the extension of an user uploading img file
                    ...
                    if(in_array($img_ext, $extension) == true){//if user uploaded img ext is matched with any array extensions
                        $time = time(); //this will return us current time
                                        //we need thhs time because when you uploading user img to in our folder we rename user file with current time
                                        //so all the imag file will have a unque name
